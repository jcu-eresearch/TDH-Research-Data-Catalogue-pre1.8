...
===="""
    ...
    def __upgrade(self, formData):
        ...
        #JCU Commented out, these checkboxes should not be set to a value of 'external' or 'off', it should be 'on'.
        #counter = 1
    ...
    def __mapField(self, oldBase, digits):
        ...
        #JCU: prevent the 'Licence' field from being moved to 'Licence Other'
