var DropDownWidgetBuilder = function($, jaffa) {
    var dropDownClass = jaffa.widgets.baseWidget.extend({
        ...
        buildUi: function() {
            ...
            var dataSortField = this.getConfig("data-sort-field");
            if  (dataListKey != null){
            ...
            if  (dataSortField != null){
                 this.dropDownData.sort(function (a, b){
                     var a1= a[dataSortField].toLowerCase(), b1= b[dataSortField].toLowerCase();
                     if(a1== b1) return 0;
                     return a1> b1? 1: -1;
                 });
            }
            else if  (dataIdKey != null){
                this.dropDownData.sort(function (a, b){
