...
class AttachmentsData:
        ...
        try:
            ...
            attachMetadata = {
                ...
                "formData": {
                    ...
                    "fileDescription" : attachFormData.getString("", ["fileDescription"]),
                    "owner" : self.vc("page").authentication.get_username()
                }
            }

            # Record an attachment in attachments.metadata
            attachment = self.__createAttachmentJson(foid, attachMetadata["formData"]["attachment_type"], attachMetadata["formData"]["description"], attachMetadata["formData"]["filename"], attachMetadata["formData"]["fileDescription"])
    ...
    def __getAttachedFiles(self, oid, attachType):
        ...
        files = [{
            ...
            "fileDescription" : doc.getFirst("fileDescription")
    ...
    def __createAttachmentJson(self, oid, attachment_type, description, filename, fileDescription, access_right="public"):
        """
        ...
        attachment.put("fileDescription", fileDescription)
        return attachment
