## This file was only added to the JCU Institutional build to fix a bug in __loadSolrData
## that was preventing the download of attached files;
## When upgrading, if the fix is contained in the new version, this file can be removed from the institutional build.
...
class DownloadData:
    ...
    def __loadSolrData(self, oid):
        ...
        ##JCU Bug Fix: the following line was tabbed over, otherwise attached files could not be downloaded
